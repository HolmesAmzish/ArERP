        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProcessRoutes_Bom_BillOfMaterialId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BomLines_Bom_BomHeaderId",
                        column: x => x.BomHeaderId,
                        principalTable: "Bom",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BomLines_Items_MaterialItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkOrders_Items_ProductItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Machines_Workshops_WorkshopId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessOperations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProcessOperations_Workshops_WorkshopId",
                        column: x => x.WorkshopId,
                        principalTable: "Workshops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseOrdersLines", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "ProcessRouteLines",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RouteId = table.Column<int>(type: "int", nullable: false),
                    ProcessOperationId = table.Column<int>(type: "int", nullable: false),
                    Sequence = table.Column<int>(type: "int", nullable: false),
                    StandardTime = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessRouteLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProcessRouteLines_ProcessOperations_ProcessOperationId",
                        column: x => x.ProcessOperationId,
                        principalTable: "ProcessOperations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProcessRouteLines_ProcessRoutes_RouteId",
                        column: x => x.RouteId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BomLines_MaterialItemId",
                table: "BomLines",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Machines_WorkshopId",
                table: "Machines",
                column: "WorkshopId");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessOperations_WorkshopId",
                table: "ProcessOperations",
                column: "WorkshopId");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessRouteLines_ProcessOperationId",
                table: "ProcessRouteLines",
                column: "ProcessOperationId");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessRouteLines_RouteId",
                table: "ProcessRouteLines",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessRoutes_BillOfMaterialId",
                table: "ProcessRoutes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrders_ProductItemId",
                table: "WorkOrders",
