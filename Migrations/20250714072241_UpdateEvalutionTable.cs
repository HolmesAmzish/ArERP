...
{
    /// <inheritdoc />
    public partial class UpdateEvalutionTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EvaluationHeaderId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluationDetail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EvaluationDetail_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EvaluationDetail_EvaluationHeader_EvaluationHeaderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationDetail_EmployeeId",
                table: "EvaluationDetail",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EvaluationDetail_EvaluationHeaderId",
                table: "EvaluationDetail",
